...
\usepackage[top=0.75in, bottom=0.5in, left=0.5in, right=0.5in, headheight=16pt]{geometry}
\usepackage{graphicx}
\usepackage{hyperref}
\usepackage{tikz}
\usepackage{forloop}
...
\noindent
\begin{longtable}{|p{0.7\textwidth}|p{0.1\textwidth}|p{0.1\textwidth}|}
    \hline
...
\forloop{flashcard}{1}{\value{flashcard} < \numflashcards}{%
    ...
    \begin{center}
        ...
        \hyperlink{notes\arabic{cardnumber}}{\textbf{\color{white}\fcolorbox{black}{blue}{Notes}}}
    \end{center}
    \newpage
}
